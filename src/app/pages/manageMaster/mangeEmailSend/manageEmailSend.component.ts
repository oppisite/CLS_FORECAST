...
@Component({
    selector: 'manageEmailSend',
    templateUrl: 'manageEmailSend.component.html', 
    providers: [GridJsService, DecimalPipe, ConsService]
})
export class manageEmailSendComponent {
    // Table data
    ...
    select_year:any;
    MAS_EMAIL_SEND: any;
    old_MAS_EMAIL_SEND: any;
    private dataSubscription: any;
    List_MAS_EMAIL_SEND: any[] = [];
    ...
    ngOnInit(): void  {
        ...
        let model ={
            FUNC_CODE: "FUNC-GET_DATA_MAS_EMAIL_SEND",
          ...
          getData.subscribe((response: any) => {
            ...
            if (response.RESULT == null) {
                this.MAS_EMAIL_SEND = response.MAS_EMAIL_SEND;
                this.old_MAS_EMAIL_SEND = response.MAS_EMAIL_SEND;
                this.List_MAS_EMAIL_SEND = response.List_MAS_EMAIL_SEND;
                this.service.setGridData(this.List_MAS_EMAIL_SEND);
            }else{
              Swal.fire({
...
*/
    ...
    fullModal(smallDataModal: any, data: any) {
        ...
        this.MAS_EMAIL_SEND = data || this.old_MAS_EMAIL_SEND;
    }
    ...
    saveEmailSend() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                let model ={
                    FUNC_CODE: "FUNC-SAVE_DATA_MAS_EMAIL_SEND",
                    MAS_EMAIL_SEND: this.MAS_EMAIL_SEND,
                    AUTHEN_INFORMATION: this.userData
                }
                var getData = this.consService.GatewayGetData(model);
                getData.subscribe((response: any) => {
